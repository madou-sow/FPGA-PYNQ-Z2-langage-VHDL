...
online_kmeans(X, 3)
print ("\n=== Méthode 1 ===")
print ("Durée d'exécution de la fonction online_kmeans avec la Méthode 1
en seconde = ", temps)
import math
temps = time.time()
...
print ("\n=== Méthode 2 ===")
print ("Durée d'exécution de la fonction online_kmeans_centroids avec la
Méthode 2 en seconde = ", temps)
...
elapsed = end - start
print ("\n=== Méthode 4 ===")
print ("Execution time of online_kmeans_centroids avec la méthode
4 : %f " % elapsed)
...
### Benchmark de la fonction online_kmeans avec un décorateur avec la
fonction timer_func et le module time
import random
import time
def timer_func(func):
...
n'.format(my_func.__name__, (tend - tstart) * 1000))
return output
return timed
@timeit
def online_kmeans(X, k):
...
time.gmtime(elapsed))
print ("\n=== Méthode 9 ===")
print('Temps d\'exécution "{}": {} sec'.format(func.__name__,
readable))
return result
return wrapper
@time_it
...
return C
online_kmeans(X,k)
####### Benchmark de la fonction online_kmeans avec la méthode de
Jonathan Kosgei et un decorateur simple
import timeit
from functools import wraps, reduce
def timer(function):
def new_function():
